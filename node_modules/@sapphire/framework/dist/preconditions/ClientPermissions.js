...
class CorePrecondition extends Precondition_1.Precondition {
    ...
    run(message, _command, context) {
        ...
        if (!message.client.id) {
            return this.error({
                identifier: "preconditionClientPermissionsNoClient" /* PreconditionClientPermissionsNoClient */,
        ...
        return missing.length === 0
            ? this.ok()
            : this.error({
                identifier: "preconditionClientPermissions" /* PreconditionClientPermissions */,
