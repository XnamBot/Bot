...
import { Snowflake, Message, Permissions, Collection, PermissionResolvable, DMChannel, CategoryChannel, NewsChannel, ThreadChannel, TextChannel, StageChannel, VoiceChannel, GuildMember, Role, User, ClientOptions, Client, ClientEvents, Guild, PartialDMChannel } from 'discord.js';
...
declare abstract class Command<T = Args, O extends Command.Options = Command.Options> extends AliasPiece<O> {
     ...
     */
    preParse(message: Message, parameters: string, context: Command.Context): Awaitable<T>;
    /**
     ...
     */
    abstract messageRun(message: Message, args: T, context: Command.Context): Awaitable<unknown>;
    /**
...
declare class Args {
     ...
     */
    readonly commandContext: Command.Context;
    /**
    ...
    constructor(message: Message, command: Command, parser: Lexure.Args, context: Command.Context);
    /**
...
declare class CorePrecondition$b extends Precondition {
    ...
    static readonly readablePermissions: {
