 ...
 * ```
 */
interface PaginatedMessageAction extends Omit<InteractionButtonOptions, 'customId' | 'style'>, Omit<MessageSelectMenuOptions, 'customId'> {
    customId: string;
...
declare class PaginatedMessage {
     ...
     */
    protected hasEmittedWarning: boolean;
    /**
     ...
     */
    setActions(actions: PaginatedMessageAction[]): this;
    /**
     ...
     */
    protected setUpMessage(channel: Message['channel'], targetUser: User): Promise<void>;
    /**
