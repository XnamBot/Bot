...
class PaginatedFieldMessageEmbed extends PaginatedMessage_1.PaginatedMessage {
    constructor() {
        ...
        Object.defineProperty(this, "embedTemplate", {
            ...
            configurable: true,
            writable: true,
            value: new discord_js_1.MessageEmbed()
        });
    ...
    setTemplate(template) {
        this.embedTemplate = template instanceof discord_js_1.MessageEmbed ? template : new discord_js_1.MessageEmbed(template);
        return this;
    }
    /**
    ...
    generatePages() {
        const template = this.embedTemplate instanceof discord_js_1.MessageEmbed ? this.embedTemplate.toJSON() : this.embedTemplate;
        for (let i = 0; i < this.totalPages; i++) {
            const clonedTemplate = new discord_js_1.MessageEmbed(template);
